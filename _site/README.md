...
- changes _themes for color
modified
_includes/footer.html
_includes/header.html includes header etc info, that's where I added the CV in the bar.
_includes/module.html is what I wrote for the news
_layouts/page.html
